...
static_assert(std::is_same_v<Error, fastly_compute_at_edge_types_error_t>);

bool error_is_generic(Error e) { return e == FASTLY_COMPUTE_AT_EDGE_TYPES_ERROR_GENERIC_ERROR; }
...
bool error_is_bad_handle(Error e) { return e == FASTLY_COMPUTE_AT_EDGE_TYPES_ERROR_BAD_HANDLE; }
